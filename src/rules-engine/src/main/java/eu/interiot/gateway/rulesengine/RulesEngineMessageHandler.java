...
public class RulesEngineMessageHandler implements MessageHandler{
	
	private RuleService ruleService;
	private VirtualStorage virtualStorage;
	
	public RulesEngineMessageHandler(RuleService ruleService, VirtualStorage virtualStorage) {
	...
	public void handleMeasurementMessage(MeasurementMessage message) {
		ruleService.sendMeasurement(virtualStorage.getDeviceById(message.getDeviceId()), message.getMeasurement());
	}
