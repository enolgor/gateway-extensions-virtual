...
public class ExecutionContext {
	...
	public ExecutionContext(BundleContext context) {
		this.connector = context.getService(context.getServiceReference(RemoteConnector.class));
	}
	
	public void sendAction(String deviceId, Action action) throws Exception {
		ActionMessage actionMessage = new ActionMessage();
		actionMessage.setDeviceId(deviceId);
		actionMessage.setAction(action);
		this.connector.send(actionMessage);
	}
}
