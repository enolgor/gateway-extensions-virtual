...
public class EsperStatement extends Statement{
	private final EPStatement epStatement;
	
	public EsperStatement(String statement, EPStatement epStatement) {
		super(statement);
	...
	@Override
	public boolean eval(DeviceDefinition device, MeasurementData data) {
		return false;
	}
}
